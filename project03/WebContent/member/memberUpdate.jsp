		...
		<form action="memberUpdate.do" method="post" name="frm">
			<table>
				<tr>
					...
					<td><input type="text" name="emp_name" size="20"
						value="${mVo.emp_name}" readonly>*</td>
				</tr>
				<tr>
					<th scope="row">아이디</th>
					<td>
						<input type="text" name="emp_id" size="20" value="${mVo.emp_id}" readonly>* 
				...
				<tr>
					<th scope="row">부서명</th>
					<td><input type="text" name="emp_dept" size="20"
						value="${mVo.emp_dept}" readonly>ex)영업부</td>
				</tr>
				<tr>
					<th scope="row">전화번호</th>
					<td><input type="text" name="emp_phone" size="13"
